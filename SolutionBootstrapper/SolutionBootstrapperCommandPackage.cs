//------------------------------------------------------------------------------
// <copyright file="SolutionBootstrapperCommandPackage.cs" company="Company">
...
namespace SolutionBootstrapper
{
    ...
    [Guid(SolutionBootstrapperCommandPackage.PackageGuidString)]
    [SuppressMessage("StyleCop.CSharp.DocumentationRules", "SA1650:ElementDocumentationMustBeSpelledCorrectly", Justification = "pkgdef, VS and vsixmanifest are valid VS terms")]
    public sealed class SolutionBootstrapperCommandPackage : Package
    {
        /// <summary>
        /// SolutionBootstrapperCommandPackage GUID string.
        /// </summary>
